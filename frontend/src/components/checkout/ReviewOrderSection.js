        ...
        <div className="bg-[#f9fafb] border-t border-[#e5e7eb] px-6 py-4 flex gap-4">
          ...
          <div className="flex-1 flex flex-col items-center">
            <button
              ...
              className={`w-full py-3 bg-[#7a0b10] hover:bg-[#5e080c] text-[13px] font-bold text-[#ffffff] uppercase tracking-wider rounded-xl shadow-md flex items-center justify-center gap-1.5 ll-interactive ll-focus-ring ${
            ...
            <p className="text-[11px] text-[#6b7280] mt-2 text-center leading-tight">
              By placing this order, you agree to our <a href="/terms-conditions" target="_blank" rel="noopener noreferrer" className="text-[#7a0b10] hover:underline font-bold">Terms, Cancellation & Refund Policy</a>.
            </p>
          </div>
        </div>
