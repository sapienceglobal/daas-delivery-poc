...
export default function ReferTab({ user }) {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-[20px] sm:text-[24px] font-black text-[#1a1a1a]">Refer & Earn</h2>
        <p className="text-[13px] sm:text-[14px] text-[#6b7280]">Share the love and get rewarded for every friend you refer.</p>
      </div>

      {/* Main Promo Banner */}
      <div className="bg-[#fcf3e3] rounded-3xl p-6 sm:p-8 md:p-10 border border-[#f5a623] relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-lg mx-auto">
          <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-white flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-sm">
            <Gift className="h-6 w-6 sm:h-8 sm:w-8 text-[#f5a623]" />
          </div>
          
          <h3 className="text-[24px] sm:text-[28px] font-black text-[#1a1a1a] leading-tight mb-3 sm:mb-4">
            Give $10, Get $10
          </h3>
          <p className="text-[14px] sm:text-[15px] text-[#4b5563] mb-6 sm:mb-8 leading-relaxed">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl p-5 sm:p-6 border border-[#eadfdb] shadow-sm text-center">
