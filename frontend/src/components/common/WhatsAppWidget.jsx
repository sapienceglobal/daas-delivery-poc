    ...
    `}>
      ...
      {isOpen && (
        <div className="mb-4 w-[320px] bg-[#ffffff] rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.15)] overflow-hidden animate-in slide-in-from-bottom-5 fade-in duration-300 border border-[#e5e7eb] origin-bottom-right">
          ...
          {/* Header - Official WhatsApp Theme */}
          <div className="bg-[#128C7E] p-5 text-[#ffffff] relative">
            <button 
      ...
      <div className="flex items-center gap-3 relative group">
        ...
        <button 
          ...
          className={`w-[44px] h-[44px] bg-[#25D366] text-[#ffffff] rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:scale-110 transition-transform z-10 relative ${isOpen ? 'rotate-90' : 'rotate-0'} duration-300`}
        >
          {isOpen ? (
            <X className="w-6 h-6" />
          ) : (
