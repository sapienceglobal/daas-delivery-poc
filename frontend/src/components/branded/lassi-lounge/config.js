...
export const menuCategoryContent = {
  ...
  categories: [
    ...
    { id: 'tandoori', label: 'Tandoori Specials', icon: '/images/branded/lassi-lounge/categories/appetizers.jpg' },
    { id: 'biryani', label: 'Biryani & Rice', icon: '/images/branded/lassi-lounge/categories/biryani.jpg' },
    { id: 'breads', label: 'Breads', icon: '/images/branded/lassi-lounge/categories/breads.jpg' },
    { id: 'chaat', label: 'Street Food & Chaat', icon: '/images/branded/lassi-lounge/categories/appetizers.jpg' },
    { id: 'soups', label: 'Soups & Salads', icon: '/images/branded/lassi-lounge/categories/beverages.jpg' },
    { id: 'sides', label: 'Accompaniments', icon: '/images/branded/lassi-lounge/categories/breads.jpg' },
